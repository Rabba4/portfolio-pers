    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <motion.div
          ...
          animate="visible"
        >
          {/* Avatar - shown above text on mobile, right column on desktop */}
          <motion.div
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              >
                ...
                />
                {/* Ring glow */}
                <div className="absolute inset-0 rounded-full ring-8 ring-primary/10" />
                {/* Avatar with fallback initials */}
                <div className="absolute inset-3 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 border-4 border-primary/40 overflow-hidden flex items-center justify-center">
                  <span className="text-4xl lg:text-6xl font-bold text-primary/60">RB</span>
                </div>
              </motion.div>
            </div>
          </motion.div>
